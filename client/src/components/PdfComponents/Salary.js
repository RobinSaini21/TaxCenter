  ...
  <div>
    <Formik
      ...
      onSubmit={(values, { setSubmitting }) => {
       ...
       const data = {employerename,employercategory, whether,professionaltax,taxablesalary}
salaryapi(data)
        setTimeout(() => {
    ...
    >
      {({
        ...
        <form type="submit" onSubmit={handleSubmit}>
            ...
            <input class="form-control item h-10"     
            id="professionaltax"
            type="text"
       ...
       <option value="" class="form-control item"   disabled>
          ...
          <option value="Pervious">Pervious
         ...
         <span style={{color:"red" }} >{errors.whether}</span> 
            ...
            <div class="form-group">
                <input type="text" class="form-control item h-10"     
            id="professionaltax"
            type="number"
