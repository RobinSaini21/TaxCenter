        ...
        <div class="row ">
          <div class="col-md-7 px-3">
            <div class="card-block px-6">
              ...
              <div className="PanCa">
                  <p>Is This a New/first (Original) Income-tax Return for the Income earnd between 1st April 2020 and 31st 2021 that you are filing this</p>
              ...
              >
                ...
                <option value="Yes (New/Original Return)">Yes (New/Original Return)</option>
                <option value="No(I'm Filing s Revised Return)">No(I'm Filing s Revised Return)</option>

              </select>
              <span style={{color: "red"}}>{errors.regime}</span>
            </div>
                <br />
              </div>
