            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3 text-center">
                        ...
                        <div class="d-flex justify-content-end" style={{ width: "370px"}}>
                          <Facebook/>
                        </div>
                     <div class="goBtn d-flex justify-content-start" style={{ width: "370px" }}>
                       <MyGoolgeLogin/>
                     </div>
                    </div>
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input class="mb-4" type="text" id="email" name="email" value={values.email} onChange={handleChange} placeholder="Enter a valid email address"/> 
                    ...
                    <div class="row px-3"> <label class="mb-1">
                        ...
                        </label> <input type="password" name="password" id="password" value={values.password} onChange={handleChange} placeholder="Enter password"/>
                    ...
                    <div class="row mb-3 px-3"> <button type="submit" class="btn btn-primary text-center" type="submit" >Login</button> </div>
