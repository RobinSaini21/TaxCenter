    ...
    <div>
      ...
      >
        ...
        <div class="card-body card-padding">
          <h4 class="f-400 p-b-20">
            Here are the key fields of your Form-16. Please re-confirm and
            'Continue'.
          </h4>
          <div id="ass_form" class="m-t-10">
            <div class="form-horizontal">
              <div class="form-group">
                ...
                <label
                  class="col-sm-2 col-xs-6 text-right"
                  id="summary_income_salary"
                >
                  {incomefromsalary}
                </label>
              </div>
              <div
                class="form-group display-none"
                id="tr_summary_house_property"
                style={{ display: "none" }}
              >
                <label class="col-sm-4 col-md-3 col-xs-6 control-label f-14 text-left-imp">
              ...
              <div
                class="form-group display-none"
                id="tr_summary_relief"
                style={{ display: "none" }}
              >
                <label class="col-sm-4 col-md-3 col-xs-6 control-label f-14 text-left-imp">
                  Relief
                </label>
                <label class="col-sm-2 col-xs-6 text-right" id="summary_relief">
                  0
                </label>
              </div>
              <div class="form-group">
          ...
          <div class="col-sm-12 p-0">
            <div class="row c-gray">
              <div class="col-sm-5 col-xs-3">
                ...
                <div class="f-16 hidden-xs c-gray" id="previous_link_text">
                  Edit
                </div>
              </div>
              <div class="col-sm-5 col-sm-offset-2 col-xs-9 text-right">
                <a href="javascript:void(0);" onclick="saveForm16Data();">
                  ...
                  <Link to={`/basicuser/${auth}`}>
                    <div class="f-18" id="next_link_text">
                      Continue
                    </div>
                  </Link>
                </a>
